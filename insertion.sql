...
insert into volpassager values (144,TO_TIMESTAMP('2014-07-02 06:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,3323,'Mali','France',400,20,30,12);
insert into volpassager values (145,TO_TIMESTAMP('2014-07-05 07:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),33,5223,'ALGERIE','France',400,20,30,13);
insert into volpassager values (146,TO_TIMESTAMP('2014-07-02 08:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),22,1223,'MAROC','France',400,20,30,32);
insert into volpassager values (147,TO_TIMESTAMP('2014-07-03 03:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,2623,'CAMEROUNE','France',400,20,30,22);
insert into volpassager values (148,TO_TIMESTAMP('2014-07-05 02:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,2223,'Mali','France',400,20,30,42);
insert into volpassager values (149,TO_TIMESTAMP('2014-07-06 01:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,2923,'Mali','France',400,20,30,52);
insert into volpassager values (140,TO_TIMESTAMP('2014-07-07 09:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),44,8223,'TUNIS','France',400,20,30,52);
insert into volpassager values (141,TO_TIMESTAMP('2014-07-08 09:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,2223,'GUINNE','France',400,20,30,62);
insert into volpassager values (142,TO_TIMESTAMP('2014-07-09 09:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),66,2333,'Mali','France',400,20,30,12);
insert into volpassager values (143,TO_TIMESTAMP('2014-07-02 06:14:00.742000000', 'YYYY-MM-DD HH24:MI:SS.FF'),8,1123,'USA','France',400,20,30,12);


insert into pilote values (10,'momo','toure','rue askia modibo','Mali',500,2,140);
insert into pilote values (11,'SALIF','toure','rue stalingrad ','France',900,3,142);
insert into pilote values (12,'drissa','cisse','rue valie ','USA',500,4,143);
insert into pilote values (13,'cisse','toure','rue mohamed IV ','Mali',5000,2,145);
insert into pilote values (14,'fatim','moi','rue  modibo keita','ALGER',500,5,145);
insert into pilote values (15,'kadi','coul','rue alpha','TUNIS',5008,6,146);
insert into pilote values (16,'soufiane','kabad','rue beta ','Mali',600,7,146);
insert into pilote values (17,'idriss','sagara','rue askia ','ALGER',300,8,147);
insert into pilote values (18,'yacouba','sagara','rue bu ','Mali',100,4,148);
insert into pilote values (19,'addrahamane','ab','rue as be','TUNIS',50,5,148);

insert into hotesse values (20,'mousou','prpe','Arabe','Français','espagnol',500,2,140);
insert into hotesse values (21,'BATOS','toi','bambara','Français','espagnol',500,3,141);
insert into hotesse values (22,'kadi','moi','peul','Français','espagnol',500,3,142);
insert into hotesse values (23,'dene','prpe','dogon','Français','espagnol',500,4,140);
insert into hotesse values (24,'totuot','il','Arabe','Français','espagnol',500,4,144);
insert into hotesse values (25,'mousou','ou','senoufo','Français','espagnol',500,5,145);
insert into hotesse values (26,'ramos','prpe','Arabe','Français','espagnol',500,6,146);
insert into hotesse values (27,'mousou','ellle','marakakan','Français','espagnol',500,7,147);
insert into hotesse values (28,'cristiano','preepe','Arabe','Français','espagnol',5008,8,148);
insert into hotesse values (29,'ronaldo','sonppa','songhoi','Français','espagnol',500,8,141);
